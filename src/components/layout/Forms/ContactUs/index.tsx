          ...
          <Form className="space-y-4">
            ...
            <div>
              <Field
                ...
                placeholder="Message"
                rows={4}
                className={`w-full px-4 py-3 bg-[var(--bg-form-field)] backdrop-blur-sm border rounded-lg text-[var(--text-primary)] placeholder-[var(--text-secondary)] font-body focus:outline-none transition-colors resize-none ${
